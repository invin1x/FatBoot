...
FAT_BUFFER   EQU RELOC_ADDR + 512 + 11  ; 1 sector (usually 512 bytes)
...
.read:
    ...
    cmp ax, 0xFFEF - 2              ; Check if cluster index is valid
    ...
    mov bx, 2                       ; BX = 2
    mul bx                          ; DX:AX = FAT value address rel to FAT LBA
    ...
    mov ax, [FAT_BUFFER + bx]       ; AX = next cluster number
    cmp ax, 0xFFF7                  ; Check if EOF
