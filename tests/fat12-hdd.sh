...
dd if=/dev/zero of=../bin/image.bin bs=1M count=10      # 10 MiB disk
mkfs.fat -F 12 ../bin/image.bin
...
# Apply ZBS
../apply-zbs.sh ../bin/image.bin FAT12 0 TEST.BIN 0x1234:0x5678 0x1234:0x5678
